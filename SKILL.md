---
name: a-dockerfile-generator-that-creates-optimized
description: A Dockerfile generator that creates optimized, multi-stage Dockerfiles. Given a language and framework, it...
version: 0.1.0
license: Apache-2.0
---

# Purpose
Implement the idea: A Dockerfile generator that creates optimized, multi-stage Dockerfiles. Given a language and framework, it produces a Dockerfile following best practices for layer caching, security, and image size.
